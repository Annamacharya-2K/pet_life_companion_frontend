...
export const Contact = (props) => {
  ...
  const [service, setService] = useState('regularBath');
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      ...
                      <select className='form-control' onChange={(e) => setService(e.target.value)} value={service} required>
                        <option value="regularBath">Regular bath</option>
                        <option value="fullGroom">Full Groom</option>
                        <option value="teethCleaning">Teeth Cleaning</option>
                        <option value="healthCheckups">Health Checkups</option>
